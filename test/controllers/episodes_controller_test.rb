...
class EpisodesControllerTest < ActionController::TestCase
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post :create, episode: { audio: @episode.audio, desc: @episode.desc, language: @episode.language, title: @episode.title }
    end
  ...
  test "should update episode" do
    patch :update, id: @episode, episode: { audio: @episode.audio, desc: @episode.desc, language: @episode.language, title: @episode.title }
    assert_redirected_to episode_path(assigns(:episode))
  end
